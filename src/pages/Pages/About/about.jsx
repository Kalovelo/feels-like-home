    ...
    return (
      <div className="layout  fade-in about">
        ...
        <div className="about__container-wrapper">
          <div className="about__container about__container--left">
            ...
            <p className="layout__container-content">
              ...
              Extra points having a session in a more natural environment than a gym
              - seaside or inside a forest - for working out both the body and
              spirit. <i>What a combo!</i>
              Talking about physical and spiritual improvement, i have zeal for the
              martial artist's lifestyle, where courage, discipline & respect are the
              root elements of a fighter's spirit.
              <br />
              <br />
              <i>
                The story begins with a young kid having extra fat and a hard-copy of
                Rocky. Passion forged from the italian stallion's story.
              </i>
            </p>
          </div>
          <div className="slide-in-right about__container about__container--right">
            ...
            <p className="about__container-content">
              ...
              self-improvement, philosophy and classic literature books. By the way,
              the closer I am to nature, the more i appreciate a good poem.
              <br />
        ...
        <div className="about__container about__container--big">
          ...
          <p className="about__container-content">
            My music preference ranges from the heaviest metal riffs to the slowest,
            calming hip-hop beats. It always depends on the mood, the situtation -
            and of course - the company. <br />
            <i>
          ...
          <p>
            ...
            exchange i got some extra passion for challenges and exploration. Grew up
            with Crash Bandicoot, fell in love with Dark Souls and lately I am on a
            hunt for unique & innovating indie games.
