...
class Cookiefier extends Component {
  ...
  render() {
    return (
      <Col>
        {this.state.shown === undefined ? (
          <Col id="cookiefier" xs="10" md="8" lg="2">
            <FontAwesomeIcon
              id="cookieButton"
              onClick={this.pressedClose}
              className="rotating"
              icon={faTimes}
            />
            <h2>Tea is served with cookies!</h2>
            <p>
              In order to keep a functionality and fondness score, I am using
              Google Analytics to track visitor navigation, so later I can
              upgrade your visiting experience.{" "}
            </p>
          </Col>
        ) : (
          <div></div>
